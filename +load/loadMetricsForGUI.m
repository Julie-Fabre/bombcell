...
[uniqueTemplates, ~, ephysData.spike_times_samples, ephysData.spike_templates, ephysData.template_amplitudes, ...
    ...
    qm.removeDuplicateSpikes(ephysData.spike_times_samples, ephysData.spike_templates, ephysData.template_amplitudes,...
...
if ~exist('forGUI', 'var') || ~isempty(dir([savePath, filesep, 'templates.qualityMetricDetailsforGUI.mat']))
    ...
    for iUnit = 1:length(uniqueTemplates)
        ...
        [~, ~, ~, forGUI.peakLocs{iUnit},...
            ...
            forGUI.tempWv(iUnit,:)] = qm.waveformShape(templateWaveforms, thisUnit, qMetric.maxChannels(iUnit),...
        ...
        if param.computeDistanceMetrics
            [~, ~, ~, ...
                forGUI.d2_mahal{iUnit}, forGUI.mahalobnis_Xplot{iUnit}, forGUI.mahalobnis_Yplot{iUnit}] = qm.getDistanceMetrics(pcFeatures, ...
