        ...
        if plotConditions(i)
            ...
            switch i
                ...
                case 3 % isSomatic
                    ...
                    ylabel('norm. unit count')
                    xlabel('somatic?')
                case 4 % fractionRPVs_estimatedTauR
                ...
                case 6 % percentageSpikesMissing_gaussian
                ...
                case 7 % percentageSpikesMissing_symmetric
                ...
                case 11 % waveformDuration_peakTrough
                    ...
                    xlabel(['waveform', newline, 'duration'])
                               case 12 % waveformBaselineFlatness
