...
if param.plotGlobal
    ...
    try
        ...
        title([num2str(sum(unitType == 1)), ' single units, ', num2str(sum(unitType == 2)), ' multi-units, ', ...
            num2str(sum(unitType == 0)), ' noise units, ', num2str(sum(unitType == 3)), ' non-somatic units.']); hold on;
            ...
            if plotConditions(i)
                ...
                switch i
                    ...
                    case 3 % second peak to trough ratio
                        ...
                        num_bins = 40; % Adjust this value as needed
                    ...
                    case 7 % RPV_tauR_estimate
                        ...
                        histogram(tauR_values(qMetric.RPV_tauR_estimate), 10, 'FaceColor', colorMtx(7, 1:3), 'FaceAlpha', colorMtx(5, 4), 'Normalization', 'probability');
                        set(gca, 'yscale', 'log')
                        yLim = ylim;
                        ylabel('norm. unit count')
                    ...
                    case 8 % percentageSpikesMissing_gaussian
                        ...
                        histogram(qMetric.percentageSpikesMissing_gaussian, 10, 'FaceColor', colorMtx(8, 1:3), 'FaceAlpha', colorMtx(6, 4), 'Normalization', 'probability');
                        yLim = ylim;
                    ...
                    case 9 % percentageSpikesMissing_symmetric
                        histogram(qMetric.percentageSpikesMissing_symmetric, 40, 'FaceColor', colorMtx(9, 1:3), 'FaceAlpha', colorMtx(7, 4), 'Normalization', 'probability');
                        yLim = ylim;
                        ylabel('norm. unit count')
                    ...
                    case 12 % spatialDecaySlope
                        if param.spDecayLinFit
                            ...
                            histogram(qMetric.spatialDecaySlope, 40, 'FaceColor', colorMtx(12, 1:3), 'FaceAlpha', colorMtx(12, 4), 'Normalization', 'probability');
                            yLim = ylim;
                    ...
                    case 14 % waveformBaselineFlatness
                        ...
                        histogram(qMetric.waveformBaselineFlatness, 40, 'FaceColor', colorMtx(14, 1:3), 'FaceAlpha', colorMtx(12, 4), 'Normalization', 'probability');
                        yLim = ylim;
                    ...
                    case 15 % presenceRatio
                        ...
                        histogram(qMetric.presenceRatio, 40, 'FaceColor', colorMtx(15, 1:3), 'FaceAlpha', colorMtx(13, 4), 'Normalization', 'probability');
                        yLim = ylim;
                    ...
                    case 18 % cumDriftEstimate
                        histogram(qMetric.cumDriftEstimate, 40, 'FaceColor', colorMtx(18, 1:3), 'FaceAlpha', colorMtx(15, 4), ...
                            'Normalization', 'probability');
                        yLim = ylim;
                        ylabel('norm. unit count')
