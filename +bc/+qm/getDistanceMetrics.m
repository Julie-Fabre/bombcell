function [isolationDist, Lratio, silhouetteScore, histogram_mahalUnit_counts, histogram_mahalUnit_edges, histogram_mahalNoise_counts, histogram_mahalNoise_edges] = getDistanceMetrics(pc_features, ...
