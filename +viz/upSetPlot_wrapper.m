...
if sum(ismember(unitType, 0))>0
    ...
    viz.upSetPlot(UpSet_data_noise, UpSet_labels_noise, figHandle_noise);
else
...
if sum(ismember(unitType, [1,2]))>0
    ...
    viz.upSetPlot(UpSet_data_mua, UpSet_labels_mua, figHandle_mua);
else
...
if param.splitGoodAndMua_NonSomatic
    ...
    upSetPlot(UpSet_data_muaNonSoma, UpSet_labels_muaNonSoma, figHandle_muaNonSoma);
end
end