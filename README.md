...
Toggle units by using the <font size="16"> <kbd>→</kbd> </font> and <kbd>←</kbd> keys. Navigate in time through the raw data to see this units' individual spikes with the  <kbd>↑</kbd> and <kbd>↓</kbd> keys.
