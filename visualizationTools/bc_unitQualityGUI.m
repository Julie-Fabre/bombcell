...
set(guiData.tempTitle, 'String',  sprintf(tempWvTitleText,num2str(colorsGdBad(double(qMetric.nPeaks(iCluster) <= param.maxNPeaks || qMetric.nTroughs(iCluster) <= param.maxNTroughs)+1,:)),...
    num2str(colorsGdBad(double(qMetric.somatic(iCluster) == 1)+1,:)), num2str(colorsGdBad(double(qMetric.cellLikeDuration(iCluster) == 1)+1,:)), ...
    num2str(colorsGdBad(double(qMetric.spatialDecaySlope(iCluster) > param.minSpatialDecaySlope)+1,:))));

set(guiData.tempLegend, 'String', {['is somatic =', num2str(qMetric.somatic(iCluster)), newline, 'cell-like duration =', num2str(qMetric.cellLikeDuration(iCluster))], ...
