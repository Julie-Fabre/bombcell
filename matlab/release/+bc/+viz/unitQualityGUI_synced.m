...
set(guiData.tempLegend, 'String', {['peak_2/trough =', num2str(abs(qMetric.mainPeak_after_size(iCluster)./ qMetric.mainTrough_size(iCluster))), newline,...
    ...
    ['peak_1/ peak_2 =', num2str(abs(qMetric.mainPeak_before_size(iCluster)./qMetric.mainPeak_after_size(iCluster)))], ...
    [ 'peak_{main}/trough =', num2str(abs(max([qMetric.mainPeak_before_size(iCluster), qMetric.mainPeak_after_size(iCluster)], [], 2)./ qMetric.mainTrough_size(iCluster)))],...
    })
...
set(guiData.acgBar, 'XData', ccg_t(250:301)*1000, 'YData', squeeze(ccg(250:301, 1, 1)));
