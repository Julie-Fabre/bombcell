...
if any(isnan(thisWaveform)) || all(thisWaveform == 0) % kilosort can sometimes
    ...
    [waveformDuration_peakTrough, peakLoc_forDuration, troughLoc_forDuration] = ...
        bc.qm.helpers.computeWaveformDuration_peakTrough(thisWaveform, peakLocs, troughLocs, PKS, TRS, param.ephys_sample_rate);
