...
for iAx = 1:size(all_axes, 2)
    ...
    if ~isempty(currAx)
        ...
        set(currAx, 'TickLength', [0.035, 0.035]); % Make tick marks longer.
        set(currAx, 'LineWidth', 1); % Make tick marks thicker.
