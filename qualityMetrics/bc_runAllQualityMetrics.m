...
for iUnit = 1:length(uniqueTemplates)
    ...
    [qMetric.nPeaks(iUnit), qMetric.nTroughs(iUnit), qMetric.somatic(iUnit), ...
        qMetric.peakLocs{iUnit}, qMetric.troughLocs{iUnit}, qMetric.cellLikeDuration(iUnit), ...
        qMetric.spatialDecayPoints(iUnit,:), qMetric.spatialDecaySlope(iUnit), qMetric.peakWidth{iUnit}] = bc_troughsPeaks(templateWaveforms, thisUnit, maxChannels(thisUnit), ...
