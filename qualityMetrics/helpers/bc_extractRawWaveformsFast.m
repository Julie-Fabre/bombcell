function rawWaveforms = bc_extractRawWaveformsFast(param, spikeTimes, spikeTemplates, reExtract, verbose, maxChannels)
...
%   amplitude
if nargin<8 %only apply when decompressing ' on the fly' 
    UseMaxChannels = 0;
else
    UseMaxChannels = 1;
end
